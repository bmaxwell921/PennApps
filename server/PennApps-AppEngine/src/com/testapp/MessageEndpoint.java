 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "testapp.com", ownerName = "testapp.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyAG3OUT7DIkf5FLpl9hsEMTg1SrNpRJJbM";
